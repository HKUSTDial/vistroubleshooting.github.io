...
def create_answer_prompt(title, description, doc=None, example=None,image_paths=None,external_link=None):
...
Title: {title}
Description: {description}{external_link_content}{doc_content}{example_content}

Please provide a detailed response in the following format:

1. First understand the user's visualization needs
2. Analyze the provided documentation and examples
...
def main():
    ...
    output_file = "Q4/results/generated_answers_level_2_document_example_test.json"
